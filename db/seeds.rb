...
p1 = Product.create!({title: "test", description: "Product1", image_url: "image", price: "12" , shop_id: s1.id})
p2 = Product.create!({title: "test2", description: "Product2", image_url: "image", price: "13" , shop_id: s2.id})
p3 = Product.create!({title: "test3", description: "Product3", image_url: "image", price: "14" , shop_id: s3.id})
